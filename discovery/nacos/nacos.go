...
func init() {
	discovery.MustRegister(discovery.TypeNacos, New)
}
...
// 编译期接口合规检查.
var _ discovery.Discovery = (*nacosDiscovery)(nil)
...
func (n *nacosDiscovery) Register(ctx context.Context, serviceName, address string) (string, error) {
	return n.RegisterWithProtocol(ctx, serviceName, address, discovery.ProtocolGRPC)
}
