...
func TestNacosDiscovery_RegisterEmptyName(t *testing.T) {
	...
	if !errors.Is(err, discovery.ErrEmptyName) {
		t.Errorf("期望 discovery.ErrEmptyName，得到 %v", err)
	}
}
...
func TestNacosDiscovery_RegisterEmptyAddress(t *testing.T) {
	...
	if !errors.Is(err, discovery.ErrEmptyAddress) {
		t.Errorf("期望 discovery.ErrEmptyAddress，得到 %v", err)
	}
}
...
func TestNacosDiscovery_RegisterFailed(t *testing.T) {
	...
	if !errors.Is(err, discovery.ErrRegister) {
		t.Errorf("期望 discovery.ErrRegister，得到 %v", err)
	}
}
...
func TestNacosDiscovery_UnregisterEmptyID(t *testing.T) {
	...
	if !errors.Is(err, discovery.ErrEmptyServiceID) {
		t.Errorf("期望 discovery.ErrEmptyServiceID，得到 %v", err)
	}
}
...
func TestNacosDiscovery_DiscoverError(t *testing.T) {
	...
	if !errors.Is(err, discovery.ErrDiscover) {
		t.Errorf("期望 discovery.ErrDiscover，得到 %v", err)
	}
}
